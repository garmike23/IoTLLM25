...
# --- File paths ---
files = {
    "Baseline": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/results_baseline_gpt2.csv",
    "ONNX": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/results_onnx_fp32_gpt2.csv",
    "ONNX_INT8": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/results_onnx_int8_gpt2.csv"
}
colors = {
...
plt.tight_layout()
plt.savefig("gpt2_mean_ram_usage.png", dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig("gpt2_mean_cpu_usage.png", dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig("gpt2_mean_inference_time.png", dpi=200)
plt.show()
