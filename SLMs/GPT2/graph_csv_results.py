...
graphs_directory = "~/Desktop/IoTLLM25/SLMs/GPT2/Graphs"

# CSV file paths
files = {
    "Baseline": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/csv_files/results_baseline_gpt2.csv",
    "ONNX": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/csv_files/results_onnx_fp32_gpt2.csv",
    "ONNX_INT8": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/csv_files/results_onnx_int8_gpt2.csv"
}
...
def expand(path):
    """Expand '~' and environment vars so paths always work."""
...
# CDF plots
plot_cdf_single(column="ram_after",      xlabel="RAM Usage (MB)",       save_name="gpt2_cdf_ram_after.png")
plot_cdf_single(column="cpu_usage",      xlabel="CPU Usage (%)",        save_name="gpt2_cdf_cpu_usage.png")
plot_cdf_single(column="inference_time", xlabel="Inference Time (s)",   save_name="gpt2_cdf_latency.png")
...
plt.tight_layout()
plt.savefig(save_path("gpt2_mean_ram_usage.png"), dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(save_path("gpt2_mean_cpu_usage.png"), dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(save_path("gpt2_mean_inference_time.png"), dpi=200)
plt.show()
