...
# === Paths ===
onnx_path = expand("./distilgpt2_output_int8.onnx")
tokenizer_path = expand("./distilgpt2_output")
...
# === Save plots ===
desktop_path = os.path.expanduser("~/Desktop/IoTLLM25/SLMs/DistilGPT2/Graphs/")
...
plt.ylabel("Seconds")
plt.tight_layout()
plt.savefig(os.path.join(desktop_path, "distilgpt2_inference_time_per_run.png"), dpi=200)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(desktop_path, "distilgpt2_ram_usage_per_run.png"), dpi=200)
plt.close()
...
plt.ylabel("%")
plt.tight_layout()
plt.savefig(os.path.join(desktop_path, "distilgpt2_cpu_usage_per_run.png"), dpi=200)
plt.close()
