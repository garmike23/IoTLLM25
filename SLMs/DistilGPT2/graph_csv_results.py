...
# --- File paths ---
files = {
    "Baseline": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/results_baseline_distilgpt2.csv",
    "ONNX": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/results_onnx_fp32_distilgpt2.csv",
    "ONNX_INT8": "~/Desktop/IoTLLM25/SLMs/DistilGPT2/results_onnx_int8_distilgpt2.csv"
}
colors = {
...
plt.tight_layout()
plt.savefig("distilgpt2_mean_ram_usage.png", dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig("distilgpt2_mean_cpu_usage.png", dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig("distilgpt2_mean_inference_time.png", dpi=200)
plt.show()
