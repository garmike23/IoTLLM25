...
plt.ylabel("Seconds")
plt.tight_layout()
plt.savefig(os.path.join(desktop_path, "opt_inference_time_per_run.png"), dpi=200)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(desktop_path, "opt_ram_usage_per_run.png"), dpi=200)
plt.close()
...
plt.ylabel("%")
plt.tight_layout()
plt.savefig(os.path.join(desktop_path, "opt_cpu_usage_per_run.png"), dpi=200)
plt.close()
