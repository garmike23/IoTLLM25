...
graphs_directory = "~/Desktop/IoTLLM25/SLMs/OPT/Graphs"
...
# CSV file paths
files = {
    "Baseline": expand("~/Desktop/IoTLLM25/SLMs/OPT/results_baseline_opt.csv"),
    "ONNX": expand("~/Desktop/IoTLLM25/SLMs/OPT/results_onnx_fp32_opt.csv"),
    "ONNX_INT8": expand("~/Desktop/IoTLLM25/SLMs/OPT/results_onnx_int8_opt.csv")
}
...
# CDF plots
plot_cdf_single(column="ram_after",      xlabel="RAM Usage (MB)",       save_name="opt_cdf_ram_after.png")
plot_cdf_single(column="cpu_usage",      xlabel="CPU Usage (%)",        save_name="opt_cdf_cpu_usage.png")
plot_cdf_single(column="inference_time", xlabel="Inference Time (s)",   save_name="opt_cdf_latency.png")
...
plt.tight_layout()
plt.savefig(save_path("opt_mean_ram_usage.png"), dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(save_path("opt_mean_cpu_usage.png"), dpi=200)
plt.show()
...
plt.tight_layout()
plt.savefig(save_path("opt_mean_inference_time.png"), dpi=200)
plt.show()
